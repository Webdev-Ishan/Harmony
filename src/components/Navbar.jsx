...
const Navbar = () => {
  ...
  return (
   ...
   <img onClick={()=>{navigate(-1)}} className='w-8 bg-gradient-to-r from-violet-700 to-blue-700 p-2 rounded-2xl cursor-pointer' src={assets.arrow_left} alt="" />
   <img onClick={()=>{navigate(+1)}}  className='w-8 bg-gradient-to-r from-violet-700 to-blue-700 p-2 rounded-2xl cursor-pointer' src={assets.arrow_right} alt="" />
      </div>
